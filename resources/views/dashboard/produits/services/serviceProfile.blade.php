...
<div class="content-body">
   <div class="container-fluid">
      <form method="POST" action="/update_service"  enctype="application/x-www-form-urlencoded">
         @csrf
      <div class="row page-titles mx-0">
         <div class="col-sm-6 p-md-0">
            ...
            <ol class="breadcrumb mt-3">
               <li class="breadcrumb-item"><a href="{{route(auth()->user()->role . '/produits-et-services/produits/services')}}">Services</a></li>
               <li class="breadcrumb-item active"><a href="#">service1</a></li>
               <li class="breadcrumb-item active"><a href="{{route(auth()->user()->role . '/produits-et-services/services/edit',1)}}">Modifier</a></li>
            </ol>
         </div>
                     ...
                     <div class="basic-form">
                           <div class="form-row">
                              <div class="form-group col-md-12">
                                 ...
                                 <input type="text" class="form-control"  placeholder="Nom" name="nom" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->nom}}">
                              </div>
                           </div>
                           ...
                           <div class="form-row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text" class="form-control"  name="reference" placeholder="Référence" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->reference}}">
                              </div>
                              <div class="form-group col-md-6">
                                 <div class="form-row d-flex">
                                    <div class="form-group col">
                                       <label class="text-dark fs-4">Prix</label>
                                       <input type="text" class="form-control"  name="prix" placeholder="Prix" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->prix}}">
                                    </div>
                           ...
                           <div class="form-row">
                              <div class="form-group col-md-12">
                                 ...
                                 <textarea class="form-control" name="description" rows="4" id="comment" style="border:1px solid rgba(88, 100, 170, 1)" >{{$data->description}}</textarea>
                              </div>
                           </div>
                     </div>
                  </div>
