         ...
         <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
               ...
               <ol class="breadcrumb mt-3">
                  <li class="breadcrumb-item"><a href="{{Route('ventes.factures')}}">Factures</a></li>
                  <li class="breadcrumb-item"><a href="#">E000012</a></li>
                  <li class="breadcrumb-item active"><a href="{{Route('ventes.factures.ajouter-facture')}}"> Modifier</a></li>
               </ol>
            </div>
               ...
               <div class="card">
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <div class="form-row">
                           <div class="form-group col-md-12">
                                 <label class="text-dark fs-4">Facture #</label>
                  ...
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-12">
                              <label for="" class="text-dark fs-4">Échéance</label>
                        ...
                        <div class="form-row">
                           <div class="form-group col-md-12">
                              <label for="" class="text-dark fs-4">Information de paiement</label>
                              <select class="form-control" style="border:1px solid rgba(88, 100, 170, 1)">
                                 <option value="">Information de paiement</option>
                                 <option value="">Information de paiement</option>
                              </select>
                          </div>
                        </div>
            ...
            <div class="col-md-3">
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     ***********************************-->
                     <div class="">
                        <p class="text-dark fs-4 my-1">Livrer à</p>
                        <hr>
                        <p class="text-dark m-0">EHZEJ</p>
                        <p class="text-dark m-0">RHEIU</p>
                        <p class="text-dark m-0">UFEUOIA</p>
                        <p class="text-dark m-0">mar, 83903</p>
