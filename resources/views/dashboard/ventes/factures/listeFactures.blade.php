...
<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <div class="mb-2">
            <a href="{{Route('ventes.factures.ajouter-facture')}}" class="btn px-4 text-white" style="background: #57ae74;">
                                    ...
                                    <tr>
                                       <td colspan="6">
                                          ...
                                          <div class="mt-2 mb-2">
                                             ...
                                             <a class="btn btn-outline-primary px-3" href="{{Route('ventes.factures.pdf')}}">Telecharger le PDF</a>
                                          </div>
                                          <!-- START BUTTON -->
                                       </td>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-flix gap-4">
                                          <a class="btn text-white" style="background: rgba(88, 100, 170, 1)" href="{{Route('ventes.factures.edit',1)}}"><i class="fa-solid fa-pen-to-square"></i></a>
