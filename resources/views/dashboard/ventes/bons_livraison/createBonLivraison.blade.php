...
<div class="content-body">
   <div class="container-fluid">
      ...
      <div class="alert alert-dismissible alert-alt solid fade show" style="background: #7f4df4">
         ...
         <p style="margin:0;" class="text-white">Cliquez sur le bouton "Enregistrer" pour terminer la création de la
            commande d'expédition SH0000002.</p>
      </div>
                  ...
                  <div class="basic-form">
                     <div class="form-row">
                        <div class="form-group col-md-6">
                           ...
                           <input type="text" class="form-control" value="SH0000002" readonly
                              style="border: none;border-bottom:1px solid #7f4df4">
                        </div>
                     </div>
                  </div>
               </div>
                                    ...
                                    <div class="basic-form">
                                       <div class="form-row">
                                          <div class="form-group col-md-6">
                                             ...
                                             <input type="text" class="form-control" placeholder="Libellé de l'adresse"
                                       ...
                                       <div class="form-row">
                                          <div class="form-group col-md-12">
                                             ...
                                             <input type="text" class="form-control" name="adresse1"
                                                placeholder="Address 1" style="border:1px solid rgba(88, 100, 170, 1)">
                                          </div>
                                       </div>
                                       ...
                                       <div class="form-row">
                                          <div class="form-group col-md-12">
                                             ...
                                             <input type="text" class="form-control" name="adresse1"
                                                placeholder="Address 2" style="border:1px solid rgba(88, 100, 170, 1)">
                                          </div>
                                       </div>
                        ...
                        <div class="basic-form">
                           <div class="form-row" style="">
                              <div class="form-group d-flex col-md-12">
                                 ...
                                 <div class="col-sm-6">
                                    <input type="text" value="1.00kg" class="form-control form-control-sm"
