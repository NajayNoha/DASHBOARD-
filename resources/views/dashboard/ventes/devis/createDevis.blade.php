            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
               <div class="btns mb-3 text-right">
                  ...
                  <button type="submit" class="btn btn-success text-white px-4"
                     style="font-weight: bolder">AJOUTER</button>
               </div>
            </div>
         </div>
               ...
               <div class="card">
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <div class="form-row">
                           <div class="form-group col-md-12">
                              <label class="text-dark fs-4">Devis #</label>
                     ...
                     <div class="basic-form">
                        ...
                        <div class="form-row">
                           ...
                           <button class="btn btn-primary col-md-12" data-toggle="modal"
                              data-target="#modifierAdresseFct">MODIFIER L'ADRESSE</button>
                           <!--**********************************
                           ...
                           ***********************************-->
                           <!--**********************************
                                    start Modal 
                           ***********************************-->
                           <div class="modal fade" id="modifierAdresseFct">
                              <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                 <div class="modal-content">
                                    <div class="modal-header" style="background: rgba(88, 100, 170, 1)">
                                       <h5 class="modal-title text-white">Adresse de facturation</h5>
