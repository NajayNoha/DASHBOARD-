      ...
      <div class="row page-titles mx-0">
         <div class="col-sm-6 p-md-0">
            ...
            <ol class="breadcrumb mt-3">
               ...
               <li class="breadcrumb-item active"><a href="{{Route(auth()->user()->role . '/contacts/client',$data->id)}}">Modifier</a></li>
            </ol>
         </div>
                     ...
                     <div class="basic-form">
                           ...
                           <div class="form-row">
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" readonly placeholder="Numéro client" name="id" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->id}}">
                                 </div>
                                 <div class="form-group col-md-6">
                                    <label class="text-dark fs-4">E-mails</label>
                                    <input type="email" class="form-control" placeholder="E-mails" name="email" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->email}}">
                                 </div>
                                 <div class="form-group col-md-6">
                                    @error('id')
                                       <span class="text-danger">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Site Web" name="website" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->website}}">
                                 </div>
                                 <div class="form-group col-md-6">
                           ...
                           <div class="form-row">
                                 <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Numéro de taxes" name="taxe_number"style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->taxe_number}}">
                                    <div class="row mt-2">
                                       <div class="form-group col-md-12">
                                          @error('taxe_number')
                                              <span class="text-danger">
                     ...
                     <div class="basic-form">
                        <div class="form-row">
                           <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control"  placeholder="Adress Label" name="adresse_lib" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->adresse_lib}}">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <select id="inputState" class="form-control" name="adresse_type" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->adresse_type}}">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control" placeholder="Address Phone" name="adresse_tel" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->adresse_tel}}">
                              <div class="row mt-1 mx-2">
                                 @error('adresse_tel')
                                     <label class="text-danger">{{$message}}</label>
                                 @enderror
                     ...
                     <div class="basic-form">
                        ...
                        <div class="form-row">
                           <div class="form-group col-md-6">
                              ...
                              <select id="inputState" class="form-control" name="devise" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->devise}}">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control"  name="taxe_type" placeholder="Type de Taxe" style="border:1px solid rgba(88, 100, 170, 1)" value="{{$data->taxe_type}}">
                              <div class="row mt-1 mx-2">
                                 @error('taxe_type')
                                     <label class="text-danger">{{$message}}</label>
                                 @enderror
