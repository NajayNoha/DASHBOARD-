...
<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <div class="mb-2">
            ...
            <button type="button" class="btn text-white px-4 text-white"  style="background: #57ae74;"   data-toggle="modal" data-target="#creerPriceLevel">
                        ...
                        <div class="basic-form">
                           <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <select name="" id="" class="form-select rounded-pill w-100" style="height: 35px;border:1px solid rgba(88, 100, 170, 1)">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                         ...
                                         <button type="button" class="btn text-white" data-toggle="modal" data-target="#modifierPriceLevel" style="background: rgba(88, 100, 170, 1)"><i class="fa-solid fa-pen-to-square"></i></button>
                                         <!-- end  Button trigger modal -->
                                         <!--start Modal  -->
                                         <div class="modal" id="modifierPriceLevel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog modal-dialog-centered modal-lg">
                                             <div class="modal-content">
                                                <div class="modal-header" style="background: rgba(88, 100, 170, 1)" >
                                                   <h5 class="modal-title text-white" id="exampleModalLabel">Créer un niveau de prix</h5>
                                                ...
                                                <div class="modal-body">
                                                   ...
                                                   <div class="basic-form">
                                                      <div class="form-row">
                                                         ...
                                                         <div class="form-group col-md-6">
                                                            <label for="" class="text-dark fs-4">Nom</label>
                                                            <input type="text" class="form-control input-rounded w-100"  value="Purchase Price" name="" style="border:1px solid rgba(88, 100, 170, 1);">
                                                         </div>
                                                         <div class="form-group col-md-6">
                                                            <label for="" class="text-dark fs-4">Type</label>
                                                            <select name="" id="" class="form-select rounded-pill w-100" style="height: 35px;border:1px solid rgba(88, 100, 170, 1)">
